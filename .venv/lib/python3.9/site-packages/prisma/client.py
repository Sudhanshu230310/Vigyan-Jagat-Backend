...
SCHEMA_PATH = Path('/Users/sudhanshugaur/Desktop/Vigyan Jagat/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/sudhanshugaur/.npm/_npx/55ad0b431757dc30/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    wholesalequote: 'actions.WholesaleQuoteActions[models.WholesaleQuote]'
    contactmessage: 'actions.ContactMessageActions[models.ContactMessage]'
    ...
    def __init__(
        ...
        *,
        ...
        self.wholesalequote = actions.WholesaleQuoteActions[models.WholesaleQuote](self, models.WholesaleQuote)
        self.contactmessage = actions.ContactMessageActions[models.ContactMessage](self, models.ContactMessage)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': None, 'fromEnvVar': 'POSTGRES_URL'}).resolve(),
            'source_file_path': '/Users/sudhanshugaur/Desktop/Vigyan Jagat/schema.prisma',
        }
...
class Batch:
    wholesalequote: 'WholesaleQuoteBatchActions'
    contactmessage: 'ContactMessageBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.wholesalequote = WholesaleQuoteBatchActions(self)
        self.contactmessage = ContactMessageBatchActions(self)
...
class WholesaleQuoteBatchActions:
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ContactMessageBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
